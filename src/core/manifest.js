...
import { projectRoot, resolveScoopDir, resolveSoftwareAppsDir, scoopConfigDir, pwshConfigDir } from "./paths.js";
const cache = new Map();
...
export function pathVarsForWindows(win = loadManifest('windows')) {
    ...
    return { scoopDir, softwareAppsDir, scoopConfigDir: scoopConfigDir(), pwshConfigDir: pwshConfigDir() };
}
